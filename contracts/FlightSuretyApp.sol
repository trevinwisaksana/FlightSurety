...
contract FlightSuretyApp {
    ...
    uint private constant NUMBER_OF_AIRLINES_FOR_MULTICONSESUS = 4;
    ...
    */
    modifier requireAirlinePayRegistrationFee() {
        bool hasPaidRegistrationFee = flightSuretyData.hasPaidRegistrationFee(msg.sender);
        require(hasPaidRegistrationFee == true, "Airline has not paid registration fee");
        _;
    }
    ...
    */
    function registerAirline(address airline) external
        ...
        requireAirlinePayRegistrationFee
        returns(bool success, uint256 votes)
    {
        success = false;
        votes = 1;

        if (flightSuretyData.numberOfAirlines() >= NUMBER_OF_AIRLINES_FOR_MULTICONSESUS) {
            flightSuretyData.voteToRegisterAirline(airline);

            votes = flightSuretyData.getNumberOfRegistrationVotes(airline);
            uint numberOfVotesNeeded = NUMBER_OF_AIRLINES_FOR_MULTICONSESUS.div(2);
    ...
    */
    ...
    /**
     * @dev An airline has to provide fund to register other airilines.
     *
     */
    ...
    */
    ...
    /**
     * @dev Called when user wants to buy flight insurance
     *
     */
    function buy(address airline, string flight) external payable
        requireIsOperational
    {
